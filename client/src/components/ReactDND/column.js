        ...
        {(provided, snapshot) => (
          ...
          >
            {props.tasks.map((task, index) => (
              <Task key={task.id} task={task} index={index} userID={props.userID} currState={props.currState} editTaskContentCB={props.editTaskContentCB} deleteTaskCB={props.deleteTaskCB}/>
            ))}
